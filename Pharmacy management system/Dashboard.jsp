...
<body>
	...
	<div class="container " style="width:1000px;height:400px;margin-top:8%;">
		<div class="d-inline flex w-70 h-100 ">
			<!--  Row one starts  -->
			<div class="row d-inline-flex align-start w-100 h-50 " style="margin-right:0%">
			...
			<div class="row d-inline-flex w-100 align-end" style="height:48%;margin-top:2%;">
				<div class="d-flex w-100 h-50 bg-dark" style="">
						<a class="btn btn-primary" style="width:50%;height:50%;margin-top:5%;margin-left:25%;" href="./Add">Add</a>
					</div>
					<div class="d-flex w-100 h-50 bg-dark" style="display:block;">
				...
				<div class="card d-inline-flex justify-content-center align-center w-50 h-100" >
					<div class="d-flex w-100 h-50 bg-dark" style="">
						<a class="btn btn-primary" style="width:50%;height:50%;margin-top:5%;margin-left:25%;" href="./Add">Add</a>
					</div>
					<div class="d-flex w-100 h-50 bg-dark" style="display:block;">
