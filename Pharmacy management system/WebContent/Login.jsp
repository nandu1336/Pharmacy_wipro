...
#grad1 {
  ...
  background-image: linear-gradient(white, #33cccc); /* Standard syntax (must be last) */
}
</style>
</head>
<body>
	...
	<div class="container " style="width:80%;height:600px;margin-top:5%;">
		<div class="card d-inline-flex flex-row w-100 h-100">		
			...
			<div class="d-inline-flex justify-content-center align-items-center h-100" id="grad1" style="width:50%">
				<form action="./Login" method="post">
					<div class="form-group">
				    	...
				    	<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="username" placeholder="Enter User Name">
				  	</div>
				  	<div class="form-group">
				  	...
				  	<div class="form-check">
						<input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
					  	<label class="form-check-label" for="defaultCheck1" onclick="show_password()">Show password</label>
					</div>
					<br>
